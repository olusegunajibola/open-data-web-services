...
public class MovieImpl implements Movie{
	...
	@Override
	public String getMoviesById(int id) {
		...
		query.append("SELECT ?title ?director ?year ?genres ?imdb_url ?wikidata_url").append(System.lineSeparator());
		query.append("WHERE {").append(System.lineSeparator());
		query.append("	<http://odws.univaq.it/movies/"+id+">  dbp:originalTitle ?title.").append(System.lineSeparator());
		query.append("	<http://odws.univaq.it/movies/"+id+"> dbp:director ?director.").append(System.lineSeparator());
		query.append("	<http://odws.univaq.it/movies/"+id+"> dbp:releaseDate ?year.").append(System.lineSeparator());
		query.append("	<http://odws.univaq.it/movies/"+id+"> dbp:genre ?genres.").append(System.lineSeparator());
		query.append("	<http://odws.univaq.it/movies/"+id+"> dbp:imdbId ?imdb_url.").append(System.lineSeparator());
		query.append("	<http://odws.univaq.it/movies/"+id+"> sch:sameAs ?wikidata_url").append(System.lineSeparator());
...
//		resultJSON.append("    \"vars\": [ \"title\" , \"director\" , \"year\" , \"genres\" , \"imdb_url\" , \"wikidata_url\"]").append(System.lineSeparator());
//		resultJSON.append("  } ,").append(System.lineSeparator());
